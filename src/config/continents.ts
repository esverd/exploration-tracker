/**
 * Maps country IDs (from world-countries.ts) to their continent.
 * Used for the continent filter in the World exploration list.
 */
export const CONTINENT_MAP: Record<string, string> = {
  ...
  'Congo': 'Africa', 'Dem. Rep. Congo': 'Africa',
  "C\u00f4te d'Ivoire": 'Africa', 'Djibouti': 'Africa', 'Egypt': 'Africa',
  'Eq. Guinea': 'Africa', 'Eritrea': 'Africa', 'eSwatini': 'Africa',
  ...
  'Somaliland': 'Africa', 'South Africa': 'Africa', 'S. Sudan': 'Africa',
  'Sudan': 'Africa', 'Tanzania': 'Africa', 'Togo': 'Africa',
  'Tunisia': 'Africa', 'Uganda': 'Africa', 'W. Sahara': 'Africa',
  ...
  'Bosnia and Herz.': 'Europe', 'Bulgaria': 'Europe',
  ...
  'Solomon Is.': 'Oceania', 'Tonga': 'Oceania', 'Tuvalu': 'Oceania',
